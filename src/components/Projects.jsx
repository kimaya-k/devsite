...
const F = 0.1; // inset fraction — must match the CSS `inset: -12.5%` below
...
// Deterministic tab/blank assignment — every shared edge between two
// neighboring cells gets exactly one tab and one matching blank.
