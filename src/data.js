...
export const heroBio = (
  <p className="text-xl md:text-2xl text-purple-200 font-normal leading-relaxed tracking-wide drop-shadow-[0_0_12px_rgba(192,132,252,0.35)]">
    <span className="text-white font-medium"> Hi, I'm Kimaya, a CS undergrad at Purdue University, currently working at Humana and CATME. I like to build software, web applications, and AI systems that have a real impact on the community through healthcare and education. Off the clock I'm either watching F1 or eating cake.</span>
  </p>
);
